...
final class StacktraceTest extends TestCase {
    ...
    public function testEntry() {
        $n = rand(4, 7);
        $result = PHPUnitUtils::callMethod($this->stacktraceMock, 'getDebugBacktrace', [$n, '{"customer_id":{"o":"1220457","n":"1220915"},"product_id":{"o":"0","n":"621525"}}']);

        // Ensure the first elem is not present (self)
        $this->assertEquals(count($result), ($n - 2));
        ...
        $this->assertEquals(14, $result[0]['lineno']);
        ...
        $this->assertEquals(30, $result[1]['lineno']);
        $this->assertEquals(addslashes('PhilKra\Tests\PHPUnitUtils'), $result[1]['module']);
    }
